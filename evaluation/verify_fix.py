...
def test_api_chunk_ids():
    ...
    print("🧪 Testing API chunk ID fix...")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if sources:
                ...
                if chunk_ids:
                    ...
                    print("\n❌ FAILED! No chunk IDs in response")
        ...
        print("❌ Cannot connect to API. Make sure it's running on http://localhost:8001")
