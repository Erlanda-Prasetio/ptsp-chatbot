...
if len(same_chunks) > 20:
    ...
    print(f"   [OK] Internet fallback adds coverage without breaking consistency")
    ...
    print(f"   [OK] ACCEPTABLE - Most aligned queries match, differences in new results")
print()
print(f"4. RECOMMENDATION:")
if len(same_chunks) / total_rows > 0.4:
    print(f"   [OK] Systems are compatible - differences due to internet fallback coverage")
else:
    print(f"   [SEARCH] INVESTIGATE - More than 40% queries show different chunks")
print()
