...
class EnhancedRAG:
    ...
    def _clean_answer(self, answer: str) -> str:
        ...
        # Remove any remaining "Dokumen" references at the end
        cleaned = re.sub(r'DPMPTSP telah melakukan.*$', '', cleaned, flags=re.DOTALL)
        cleaned = re.sub(r'Dokumen.*$', '', cleaned, flags=re.DOTALL)
